...
Use separate setup packs for different goals so state-changing tools do not bleed into clean-play or accessibility setups. For most players, the practical choice is the setup pack or overlay section they are importing.
