...
Akron separates player-facing workflows from submission and development policy. Use the player guide to configure the overlay and tools. Use the ruleset and reference pages when you need to understand how a feature affects attempt status.
