...
- A copied mod archive might be located in a different installation than the one currently being launched.
...
If a rendering feature behaves inconsistently across different hosts, please document the host, platform, map SID, visible policy/status state, Akron setup, and provide screenshot evidence before filing an issue.
