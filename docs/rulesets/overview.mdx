...
Primary rulesets are opt-in policy presets. Fresh installs start with `None`, which leaves Akron profiles and rulesets inactive until you choose one.

| Ruleset | Purpose |
|---|---|
| `None` | No primary ruleset is active. Features and profiles stay off until you opt in. |
