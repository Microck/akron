...
- The visible attempt status and policy badge when reporting classification behavior.
...
| Policy badge | The visible classification marker that says whether a row is Goldberry/Hardlist clear, Normal clear, or Cheat. |
