...
- Keep camera inspection tools such as free camera, camera offset, and cursor zoom in explicit map-inspection or testing setups rather than in your default play profile.
