...
- A public pack contains `manifest.json`, `setup.json`, and one v10 snapshot entry per StartPos. Its manifest `kind` is `setup` and its payload format is `akron-setup-v9`.
