...
<Steps>
  ...
  <Step title="Import the selected pack">
    Select a pack in the list, review its details on the right, and click **Import Selected**. Akron downloads the `.akr` file into `Saves/AkronProfiles/community-*.akr` and imports the declared scope.
  </Step>
</Steps>
...
- **Attempt-changing imports are policy-visible.** Imported settings that affect attempt counts may appear in ruleset status and proof metadata.
