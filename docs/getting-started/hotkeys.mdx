...
Akron uses Everest's keyboard and controller configuration for binds. Use these surfaces to ensure bindings remain consistent with your modded Celeste setup.
