...
**Save State**, **Load State**, **Previous Slot**, and **Next Slot** drive Speedrun Tool's savestate slot from 1-9; the Keybinds tab shows the first two as **Speedrun Tool Capture State** and **Speedrun Tool Restore State**. **Set StartPos**, **Load StartPos**, **Clear StartPos**, and **Load StartPos Slot 1-9** control Akron's StartPos.
