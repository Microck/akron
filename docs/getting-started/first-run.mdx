...
Follow this tutorial after installing Akron. You will open the overlay, confirm Akron is active, and understand the status Akron shows during play.
...
<Steps>
  ...
  <Step title="Open Akron">
    Press `Tab`, Akron's default overlay bind. If the bind was changed or conflicts with another mod, open Everest's mod options and find Akron's keybinding configuration.
  </Step>
