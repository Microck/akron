...
- The current Akron release through Olympus or the project's public release page.
...
Use Olympus as the main install path when possible.
...
Use the archive path when Olympus is unavailable or when you are testing a downloaded release manually.
