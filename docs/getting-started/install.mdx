...
This tutorial walks you through installing Akron into an existing Celeste + Everest setup and confirming that the mod loads.
...
Use the archive path when Olympus is unavailable or when testing a downloaded release manually.
