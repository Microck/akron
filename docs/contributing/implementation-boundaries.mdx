...
Use this reference when a change crosses UI, settings, policy, runtime behavior, `.akr` packs, commands, HUD, or tests. It describes where new code should live so contributor changes stay focused.
