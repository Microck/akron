...
<Steps>
  ...
  <Step title="Build and verify">
    Run targeted tests, build, and [live verification](/contributing/testing-and-verification) when the behavior is visual, timing-sensitive, input-driven, or map-dependent.
  </Step>
