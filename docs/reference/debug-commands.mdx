...
| `akron_ruleset <none\|casual\|practice\|leaderboard-clean\|sandbox\|everest-safe\|map-maker>` | Switch the advanced primary ruleset setting for QA or controlled verification. |
...
| `akron_prevent_down_dash_redirects <disabled\|normal\|diagonal\|toggle\|status>` | Control Prevent Down Dash Redirects mode. |
...
## Profile, Theme, and Settings Commands

| Command | Purpose |
|---|---|
| `akron_profile [none\|casual\|practice\|leaderboard-clean\|sandbox\|map-maker\|accessibility\|export [scope] [name]\|import [scope] <file>\|import-latest [scope]]` | Show, apply, import, or export Akron profiles. |
| `akron_theme <status\|next\|copy-custom\|export [name]\|import <file>\|import-latest>` | Manage overlay themes. |
| `akron_community_rulesets <list\|apply <id-or-label>>` | List or apply community rulesets. |
