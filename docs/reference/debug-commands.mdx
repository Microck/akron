...
it. Use the decoded inventory name exactly. Empty input reports
...
end of the frame and reports `qa-warp-room: room=<name>`. That line acknowledges
the request; it does not prove the room has finished loading.
