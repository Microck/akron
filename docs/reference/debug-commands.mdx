...
| Command | Purpose |
|---|---|
| `akron_profile [casual\|practice\|leaderboard-clean\|sandbox\|map-maker\|accessibility\|export [scope] [name]\|import [scope] <file>\|import-latest [scope]]` | Show, apply, import, or export Akron profiles. |
