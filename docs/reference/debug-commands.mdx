...
| `akron_room_capture <start\|stop\|status\|format <png\|jpg>\|markers <on\|off>\|startpos <on\|off>\|autokill <on\|off>\|autodeafen <on\|off>>` | Drive Room Capture. The overlay Room Capture row is the normal player-facing path. |
| `akron_map_capture <start\|stop\|status\|format <png\|jpg>\|markers <on\|off>\|startpos <on\|off>\|autokill <on\|off>\|autodeafen <on\|off>>` | Drive Map Capture. The overlay Map Capture row is the normal player-facing path. |
