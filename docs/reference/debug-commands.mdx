...
| `akron_ruleset <casual/practice/leaderboard-clean/sandbox/everest-safe/map-maker>` | Switch the advanced primary ruleset setting for QA or controlled verification. |
...
- Switch advanced ruleset settings without relying on fragile input.
