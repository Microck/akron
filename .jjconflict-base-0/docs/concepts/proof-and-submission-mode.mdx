...
For proof overlay behavior that controls what appears on screen during a run, see [Streamer Mode, Proof Mode, and Low-Distraction Overlays](/rulesets/streamer-mode-and-proof-overlays).
