...
public static class AkronFeatureRegistry {
    private static readonly Dictionary<AkronFeatureKind, FeatureDefinition> Definitions = new Dictionary<AkronFeatureKind, FeatureDefinition> {
        ...
        { AkronFeatureKind.FpsBypass, new FeatureDefinition(AkronFeatureKind.FpsBypass, AkronStatus.Cheat, "FPS bypass", "Raises the draw cadence while keeping the configured simulation cadence when possible.") },
        ...
        { AkronFeatureKind.ExtendedVariantMode, new FeatureDefinition(AkronFeatureKind.ExtendedVariantMode, AkronStatus.Cheat, "External variant mode", "Controls external runtime variants, including physics, hazards, resources, and randomizer behavior.") },
