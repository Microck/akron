...
public sealed class FeatureRegistryTests
{
    ...
    [InlineData("Logging", AkronStatus.GoldberryHardlistClean)]
    [InlineData("Journal Snapshot / Compare", AkronStatus.GoldberryHardlistClean)]
    [InlineData("Core Mode", AkronStatus.Cheat)]
    [InlineData("Set Inventory", AkronStatus.Cheat)]
    [InlineData("Dream State", AkronStatus.Cheat)]
    [InlineData("Dash Redirect", AkronStatus.Cheat)]
    [InlineData("Cursor Tools", AkronStatus.Cheat)]
    [InlineData("Previous Room In Order", AkronStatus.Cheat)]
    [InlineData("Next Room In Order", AkronStatus.Cheat)]
    [InlineData("Previous Map", AkronStatus.Cheat)]
    [InlineData("Next Map", AkronStatus.Cheat)]
    [InlineData("Previous Checkpoint", AkronStatus.Cheat)]
    [InlineData("Next Checkpoint", AkronStatus.Cheat)]
    [InlineData("Spawn Jelly", AkronStatus.Cheat)]
    [InlineData("Spawn Theo", AkronStatus.Cheat)]
    [InlineData("Open Menu", AkronStatus.RegularClean)]
    [InlineData("In-game only", AkronStatus.RegularClean)]
    [InlineData("Capture StartPos State", AkronStatus.Cheat)]
    [InlineData("Restore StartPos State", AkronStatus.Cheat)]
    [InlineData("StartPos Set", AkronStatus.Cheat)]
    [InlineData("StartPos Load", AkronStatus.Cheat)]
    [InlineData("StartPos Clear", AkronStatus.Cheat)]
    [InlineData("StartPos Previous", AkronStatus.Cheat)]
    [InlineData("StartPos Next", AkronStatus.Cheat)]
    [InlineData("StartPos Slot 9", AkronStatus.Cheat)]
    [InlineData("Custom HUD Labels", AkronStatus.Cheat)]
    [InlineData("+ Custom", AkronStatus.Cheat)]
    [InlineData("Player", AkronStatus.RegularClean)]
    [InlineData("Objects", AkronStatus.RegularClean)]
    [InlineData("Entities", AkronStatus.RegularClean)]
    [InlineData("Ambience", AkronStatus.RegularClean)]
    [InlineData("UI", AkronStatus.RegularClean)]
    ...
    [InlineData("FPS Bypass", AkronStatus.RegularClean)]
    [InlineData("TPS Bypass", AkronStatus.Cheat)]
    [InlineData("Timescale", AkronStatus.Cheat)]
    [InlineData("Control Display", AkronStatus.GoldberryHardlistClean)]
    [InlineData("Audio Speed", AkronStatus.RegularClean)]
    [InlineData("Autosave", AkronStatus.GoldberryHardlistClean)]
    [InlineData("Backups", AkronStatus.GoldberryHardlistClean)]
    [InlineData("Enabled", AkronStatus.GoldberryHardlistClean)]
    [InlineData("Create Now", AkronStatus.GoldberryHardlistClean)]
    [InlineData("Restore", AkronStatus.GoldberryHardlistClean)]
    [InlineData("Last Result", AkronStatus.GoldberryHardlistClean)]
    [InlineData("Triggers", AkronStatus.GoldberryHardlistClean)]
    [InlineData("Retention", AkronStatus.GoldberryHardlistClean)]
    public void UiRowsExposeLabelClassification(string label, AkronStatus expectedStatus)
    {
