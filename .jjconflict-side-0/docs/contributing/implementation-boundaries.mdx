...
| Community packs and rulesets | `Source/Community/akron-community-packs.cs`, `Source/Community/akron-community-pack-browser.cs`, `Source/Community/akron-community-rulesets.cs` |
...
| Profile state structure and defaults | `Source/Profiles/akron-profile-state.cs` |
...
| Profile show, apply, import, export, and sections | `Source/Commands/akron-profile-commands.cs` |
