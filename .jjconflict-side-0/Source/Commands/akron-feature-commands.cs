...
public static partial class AkronCommands {
    ...
    public static void Feature(string name = "", string action = "status") {
        ...
        bool handled = normalizedName switch {
            ...
            "preventdowndashredirects" => SetFeatureToggle(action, AkronFeatureKind.InputAssistShortcut, () => AkronModule.Settings.PreventDownDashRedirectsEnabled, value => AkronModule.Settings.PreventDownDashRedirectsEnabled = value, "prevent-down-dash-redirects"),
