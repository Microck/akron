...
Actions with a dash (—) have no default binding on that input type. The Set StartPos, Load StartPos, and Clear StartPos actions start unbound so you can assign them intentionally.
