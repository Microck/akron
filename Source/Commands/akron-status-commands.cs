...
public static partial class AkronCommands {
    ...
    public static void Status() {
        ...
        Log("auto-kill-selected-area: " + selectedAutoKillAreaNumber.ToString(CultureInfo.InvariantCulture));
        ...
        if (hasSelectedAutoKillArea) {
            Log("auto-kill-speed-condition: " + selectedAutoKillArea.SpeedCondition.ToString().ToLowerInvariant());
            Log("auto-kill-min-speed: " + selectedAutoKillArea.MinSpeed.ToString(CultureInfo.InvariantCulture));
            Log("auto-kill-max-speed: " + selectedAutoKillArea.MaxSpeed.ToString(CultureInfo.InvariantCulture));
            Log("auto-kill-horizontal-speed-condition: " + selectedAutoKillArea.HorizontalSpeedCondition.ToString().ToLowerInvariant());
            Log("auto-kill-min-horizontal-speed: " + selectedAutoKillArea.MinHorizontalSpeed.ToString(CultureInfo.InvariantCulture));
            Log("auto-kill-max-horizontal-speed: " + selectedAutoKillArea.MaxHorizontalSpeed.ToString(CultureInfo.InvariantCulture));
            Log("auto-kill-vertical-speed-condition: " + selectedAutoKillArea.VerticalSpeedCondition.ToString().ToLowerInvariant());
            Log("auto-kill-min-vertical-speed: " + selectedAutoKillArea.MinVerticalSpeed.ToString(CultureInfo.InvariantCulture));
            Log("auto-kill-max-vertical-speed: " + selectedAutoKillArea.MaxVerticalSpeed.ToString(CultureInfo.InvariantCulture));
            Log("auto-kill-dash-count-condition: " + selectedAutoKillArea.DashCountCondition.ToString().ToLowerInvariant());
            Log("auto-kill-dash-count: " + selectedAutoKillArea.DashCount.ToString(CultureInfo.InvariantCulture));
            Log("auto-kill-ground-condition: " + selectedAutoKillArea.GroundCondition.ToString().ToLowerInvariant());
            Log("auto-kill-horizontal-direction: " + DescribeAutoKillAxisCondition(selectedAutoKillArea.HorizontalDirection, horizontal: true));
            Log("auto-kill-vertical-direction: " + DescribeAutoKillAxisCondition(selectedAutoKillArea.VerticalDirection, horizontal: false));
            Log("auto-kill-state-condition: " + selectedAutoKillArea.PlayerStateCondition.ToString().ToLowerInvariant());
            Log("auto-kill-state-id: " + selectedAutoKillArea.PlayerState.ToString(CultureInfo.InvariantCulture));
            Log("auto-kill-invert-conditions: " + selectedAutoKillArea.InvertConditions.ToString().ToLowerInvariant());
        } else {
