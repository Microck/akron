...
public static partial class AkronCommands {
    ...
    public static void Feature(string name = "", string action = "status") {
        ...
        bool handled = normalizedName switch {
            ...
            "deathparticles" or "customdeathparticles" => SetFeatureToggle(action, AkronFeatureKind.DeathVisuals, () => AkronModule.Settings.CustomDeathParticles, value => AkronModule.Settings.CustomDeathParticles = value, "death-particles"),
            ...
            "norespawnanimation" => SetFeatureToggle(action, AkronFeatureKind.RespawnAnimation, () => AkronModule.Settings.NoRespawnAnimation, value => AkronModule.Settings.NoRespawnAnimation = value, "no-respawn-animation"),
            ...
            "smartstartpos" => SetPlainToggle(action, () => AkronModule.Settings.SmartStartPos, value => AkronModule.Settings.SmartStartPos = value, "smart-startpos"),
            ...
            "screenshake" => SetFeatureToggle(action, AkronFeatureKind.Screenshake, () => AkronModule.Settings.Screenshake, value => AkronModule.Settings.Screenshake = value, "screenshake"),
